...
| 날짜 | 내용 |
| --- | --- |
| 2021.03.06 | 네트워크 및 azure devops 내용 복습 |
| 2021.03.07 | 서버 인프라 및 인증과 관련된 notion 정리 및 복습 |
| 2021.03.10 | 졸업과제 프로젝트 매니징 작업 |
| 2021.03.11 | 졸업과제 프로젝트 매니징 작업 |
| 2021.03.12 | 졸업과제 프로젝트 매니징, 기술 스택 확립 |
| 2021.03.13 | 졸업과제 요구사항 확립, 제품명 결정 |
...
| 2021.03.30 | 인증 흐름 복습, 클로저 개념 이해 |
| 2021.03.31 | Material-UI 간단하게 연습 |

## 4

| 날짜 | 내용 |
| --- | --- |
| 2021.04.01 | js, react, next.js 복습 |
| 2021.04.04 | k8s pv, pvc 공부 |
...
| 날짜 | 내용 |
| --- | --- |
| 2021.06.01 | git flow 복습 및 실습 |
| 2021.06.15 | 졸업과제: 프로젝트 정리 |
...
| 2021.07.31 | 크롬 브라우저 개발자 도구 정리 |

## 8

| 날짜 | 내용 |
| --- | --- |
| 2021.08.01 | react-query 고도화 rnd |
| 2021.08.03 | react-query 고도화 rnd |
| 2021.08.04 | react-query 구독 모델 아키텍처 설계 완료 |
| 2021.08.06 | TDD 예제 정리 |
| 2021.08.07 | TDD 예제 정리 |
| 2021.08.08 | Testing Library 복습 |
| 2021.08.09 | 이전에 작성해 놓은 개발 노트 정리, storybook 컨셉 이해 |
| 2021.08.10 | node 스키마 설계 연습, html 시맨틱 태그 정리 |
| 2021.08.11 | styled-components 복습 |
| 2021.08.13 | css-in-js 메커니즘 파악, asp.net core react 환경 구성 |
| 2021.08.14 | styled-components 남은 레퍼런스 정리 |
| 2021.08.15 | 블록체인 복습 |
| 2021.08.17 | ASP.NET Core Node 스키마 SDK 개발 |
| 2021.08.22 | dom api, react 복습 |
| 2021.08.24 | react 고급 |
